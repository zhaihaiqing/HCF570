...
#define SI_POWER_ON()			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9,0)
#define SI_POWER_OFF()			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9,1)

//IO操作函数定义
#define SI_SET_SDN_HIGH()			HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,1)	//GPIOx->BSRRL = GPIO_Pin;
#define SI_SET_SDN_LOW()			HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,0)	//GPIOx->BSRRH = GPIO_Pin;
